...
export class PatientService {
  ...
  queryWithDoctorId(doctorId: number | undefined, req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPatient[]>(`${this.resourceUrl + '-doctor'}/${doctorId}`, { params: options, observe: 'response' });
  }
