...
import com.diploma.repository.PatientRepository;
...
/**
 * REST controller for managing {@link com.diploma.domain.Patient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PatientResource {
     ...
     */
    @GetMapping("/patients")
    public ResponseEntity<List<Patient>> getAllPatients(Pageable pageable, @RequestParam(required = false) String filter) {
